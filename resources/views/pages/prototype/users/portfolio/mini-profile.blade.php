<div>
    ...
    <link rel="stylesheet" href="https://unpkg.com/bs-brain@2.0.4/components/authors/author-2/assets/css/author-2.css">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title mb-2">
                                        <a class="card-link link-dark text-decoration-none" href="#!">{{ $chef->name
                                            }}</a>
                                    </h3>
